...
**URL:** [https://jurisprudencia.pj.gob.pe/jurisprudenciaweb/faces/page/resultado.xhtml](https://jurisprudencia.pj.gob.pe/jurisprudenciaweb/faces/page/resultado.xhtml)
...
**URL:** [https://publico.oefa.gob.pe/repdig/consulta/consultaTfa.xhtml](https://publico.oefa.gob.pe/repdig/consulta/consultaTfa.xhtml)
...
1. Abre tu navegador y visita: [https://jurisprudencia.pj.gob.pe/jurisprudenciaweb/faces/page/resultado.xhtml](https://jurisprudencia.pj.gob.pe/jurisprudenciaweb/faces/page/resultado.xhtml)
2. Explora el sitio para entender su estructura, navegación y funcionalidades.
3. Identifica cómo se organizan los documentos y cómo acceder a ellos.
4. Descubre cómo funciona la descarga de PDFs.
...
> **Importante:** No usar librerías que controlen un navegador (ej: Puppeteer, Playwright, Selenium).
...
- Asegúrate de que funcione correctamente con el sitio principal de jurisprudencia.
...
- El `README.md` debe incluir instrucciones claras de instalación y ejecución.
...
- ✅ **Documentación:** `README.md` claro y completo.
